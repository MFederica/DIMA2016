...
public class FragmentCookingStep extends Fragment {
    ...
    private static final String ARG_STEP_NUMBER = "com.appetite.cooking.FragmentCookingStep.ARG_STEP_NUMBER";
    private static final String ARG_RECIPE = "com.appetite.cooking.FragmentCookingStep.ARG_RECIPE";
