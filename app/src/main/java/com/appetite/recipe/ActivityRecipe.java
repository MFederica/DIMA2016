...
import com.appetite.cooking.ActivityCooking;
import com.appetite.shopping.FragmentShoppingList;
import com.appetite.R;
import com.appetite.style.ScrollAwareFABBehavior;
...
public class ActivityRecipe extends AppCompatActivity implements NetworkRecipeRequestFragment.NetworkRecipeRequestListener {
    ...
    static final String RECIPE = "com.appetite.recipe.ActivityRecipe.RECIPE"; //used to save the recipe in the instance state
    static final String RECIPE_NAME = "com.appetite.recipe.ActivityRecipe.RECIPE_NAME"; //used to save the recipe in the instance state
    static final String DOWNLOADING_STATE = "com.appetite.recipe.ActivityRecipe.DOWNLOADING_STATE";
