...
public class AdapterRecipePreparation extends RecyclerView.Adapter<AdapterRecipePreparation.ViewHolder> {
    ...
    public AdapterRecipePreparation(List<String> steps, OnListFragmentInteractionListener listener) {
        mValues = steps;
        mListener = listener;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.fragment_recipe_preparation_step_number);
