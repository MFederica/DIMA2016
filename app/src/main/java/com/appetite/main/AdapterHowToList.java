 ...
 * specified {@link FragmentHowTo.OnHowToListFragmentInteractionListener}.
...
public class AdapterHowToList extends RecyclerView.Adapter<AdapterHowToList.ViewHolder> {
    ...
    private final FragmentHowTo.OnHowToListFragmentInteractionListener mListener;
    private FragmentHowTo fht;
    private ImageLoader imageLoader = ImageLoader.getInstance();

    private Context context;

    public AdapterHowToList(Context context, List<HowToItem> items, FragmentHowTo.OnHowToListFragmentInteractionListener listener, FragmentHowTo fht) {
