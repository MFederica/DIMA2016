...
public class FragmentHome extends Fragment {
    ...
    private static final String DOWNLOAD_STATE = "com.appetite.main.FragmentRecipesList.DOWNLOAD_STATE";
    private static final String RECIPES_LIST = "com.appetite.main.FragmentRecipesList.RECIPES_LIST";
    private static final String RECIPES_DISPLAYER = "com.appetite.main.FragmentRecipesList.RECIPES_DISPLAYER";
    ...
    FragmentRecipesList.OnRecipeSelectedListener mCallBack;
    ...
    public void onAttach(Context context) {
        ...
        try {
            mCallBack = (FragmentRecipesList.OnRecipeSelectedListener) activity;
        } catch (ClassCastException e) {

            throw new ClassCastException(activity.toString() + "must implement OnRecipesSelectedListener");
        }
    }
